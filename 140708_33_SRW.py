...
eiz_z = np.loadtxt('data/eiz_z_33.txt') # LDS in parallel direction
#
...
np.savetxt('data/A0_nonscreen_n_33.txt',A0)
np.savetxt('data/A2_nonscreen_n_33.txt',A2)
np.savetxt(  'data/A0_nonscreen_33_sum.txt',sum_A0)
np.savetxt(  'data/A2_nonscreen_33_sum.txt',sum_A2)

#np.savetxt('data/A0_screen_n_33.txt',A0)
#np.savetxt('data/A2_screen_n_33.txt',A2)
#np.savetxt(  'data/A0_screen_33_sum.txt',sum_A0)
#np.savetxt(  'data/A2_screen_33_sum.txt',sum_A2)
