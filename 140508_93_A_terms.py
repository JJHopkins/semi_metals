...
pl.xlabel(r'$\ell$')
pl.savefig('plots/65_An0to400_vs_l.png')
...
pl.ylabel(r'$\mathcal{A}^{(0)}_{n}\,\, [zJ]$')
pl.xlabel(r'$\ell$')
pl.savefig('plots/65_pn0to400_vs_l.pdf')
##pl.savefig('plots/90_A_vs_n.pdf')
##pl.savefig('plots/91_A_vs_n.pdf')
##pl.savefig('plots/93_A_vs_n.pdf')
##pl.savefig('plots/290_A_vs_n.pdf')
...
pl.figure()
pl.plot(ns,2*p[ 0,:], 'b:' , label = r'$p(l=%2.1f)$'%(Ls[ 0]))
pl.plot(ns,2*p[ 1,:], 'g:' , label = r'$p(l=%2.1f)$'%(Ls[ 1]))
pl.plot(ns,2*p[ 2,:], 'r:' , label = r'$p(l=%2.1f)$'%(Ls[ 2]))
pl.plot(ns,2*p[ 3,:], 'c:' , label = r'$p(l=%2.1f)$'%(Ls[ 3]))
pl.plot(ns,2*p[ 4,:], 'y:' , label = r'$p(l=%2.1f)$'%(Ls[ 4]))
pl.plot(ns,2*p[ 5,:], 'm:' , label = r'$p(l=%2.1f)$'%(Ls[ 5]))
pl.plot(ns,2*p[10,:], 'b-.', label = r'$p(l=%2.1f)$'%(Ls[10]))
pl.plot(ns,2*p[15,:], 'g-.', label = r'$p(l=%2.1f)$'%(Ls[15]))
pl.plot(ns,2*p[20,:], 'r-.', label = r'$p(l=%2.1f)$'%(Ls[20]))
pl.plot(ns,2*p[25,:], 'c-.', label = r'$p(l=%2.1f)$'%(Ls[25]))
pl.plot(ns,2*p[30,:], 'b-' , label = r'$p(l=%2.1f)$'%(Ls[30]))
pl.plot(ns,2*p[35,:], 'g-' , label = r'$p(l=%2.1f)$'%(Ls[35]))
pl.plot(ns,2*p[40,:], 'r-' , label = r'$p(l=%2.1f)$'%(Ls[40]))
pl.plot(ns,2*p[45,:], 'c-' , label = r'$p(l=%2.1f)$'%(Ls[45]))
pl.plot(ns, p[10,:]/p[10,:], 'k-')# , label = r'$p(l=%2.1f)$'%(Ls[45]))
pl.legend(loc = 'best')      
pl.title(r'65w65 p(n,l)')
pl.ylabel(r'$p(n,l)$')
pl.xlabel(r'$n$')
pl.savefig('plots/65_pl_vs_n.pdf')
##pl.savefig('plots/90_A_vs_n.pdf')
##pl.savefig('plots/91_A_vs_n.pdf')
##pl.savefig('plots/93_A_vs_n.pdf')
##pl.savefig('plots/290_A_vs_n.pdf')
