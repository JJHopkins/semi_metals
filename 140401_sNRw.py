...
Ls = np.arange(1e-9,41e-9,10e-9)  # separation distance between 2 cyclinders
...
#np.savetxt('data/A0_65_perpendicular_NR.txt',sum_A0)
#np.savetxt('data/A2_65_perpendicular_NR.txt',sum_A2)
#np.savetxt('data/Lengths_65_perpendicular_NR.txt',Ls)
#
#np.savetxt('data/A0_90_perpendicular_NR.txt',sum_A0)
#np.savetxt('data/A2_90_perpendicular_NR.txt',sum_A2)
#np.savetxt('data/Lengths_90_perpendicular_NR.txt',Ls)
#
#np.savetxt('data/A0_91_perpendicular_NR.txt',sum_A0)
#np.savetxt('data/A2_91_perpendicular_NR.txt',sum_A2)
#np.savetxt('data/Lengths_91_perpendicular_NR.txt',Ls)
#
#np.savetxt('data/A0_93_perpendicular_NR.txt',sum_A0)
#np.savetxt('data/A2_93_perpendicular_NR.txt',sum_A2)
#np.savetxt('data/Lengths_93_perpendicular_NR.txt',Ls)
#
##np.savetxt('data/A0_290_perpendicular_NR.txt',sum_A0)
##np.savetxt('data/A2_290_perpendicular_NR.txt',sum_A2)
##np.savetxt('data/Lengths_290_perpendicular_NR.txt',Ls)
##
...
def title(cnt1,cnt2,orientation):
	return r'$\mathrm{[%s,%s]\,\,Hamaker\,coeff:\, %s \,in\,water,\,Non-retarded}$'%(cnt1,cnt2,orientation)

def svfig(cnt1,cnt2,orientation):
	return 'plots/140322_%sw%s_HCs_%s_sNRw.pdf'%(cnt1,cnt2,orientation)
