...
#
x_L,y_L = np.loadtxt('data/water-L.txt',unpack=True, usecols = [0,1])
x_pars,y_pars = np.loadtxt('data/LD_water_pars1.txt', delimiter='     ', usecols=(0,1), unpack=True)
y_w    = np.loadtxt('data/eiz_w.txt') 
y_0730 = np.loadtxt('data/140730_eiz_w.txt') 
