...
np.savetxt(  'data/A0_0L_screen_24_sum.txt',sum_A0)
np.savetxt(  'data/A2_0L_screen_24_sum.txt',sum_A2)

#np.savetxt('data/A0_nonscreen_n_24.txt',A0)
#np.savetxt('data/A2_nonscreen_n_24.txt',A2)
#np.savetxt(  'data/A0_nonscreen_24_sum.txt',sum_A0)
#np.savetxt(  'data/A2_nonscreen_24_sum.txt',sum_A2)

#np.savetxt('data/A0_screen_n_24.txt',A0)
#np.savetxt('data/A2_screen_n_24.txt',A2)
#np.savetxt(  'data/A0_screen_24_sum.txt',sum_A0)
#np.savetxt(  'data/A2_screen_24_sum.txt',sum_A2)

#np.savetxt('data/A0_450_screen_n_24.txt',A0)
#np.savetxt('data/A2_450_screen_n_24.txt',A2)
#np.savetxt(  'data/A0_450_screen_24_sum.txt',sum_A0)
#np.savetxt(  'data/A2_450_screen_24_sum.txt',sum_A2)
