...
eiz_x_051 = np.loadtxt('data/eiz_x_24.txt') # LDS in perpendicular direction
eiz_z_051 = np.loadtxt('data/eiz_z_24.txt') # LDS in parallel direction

Eiz_x_290 = np.loadtxt('data/eiz_x_93.txt') # LDS in perpendicular direction
Eiz_z_290 = np.loadtxt('data/eiz_z_93.txt') # LDS in parallel direction

eiz_x_290 =Eiz_x_290[:500]   
eiz_z_290 =Eiz_z_290[:500]  
...
#
#pl.loglog(ns,(kbT/(32.)) * A2[ 0,:],'b--')#,label=r'$A^{0,2}(\ell=%2.1f\,nm)$'%(1e9*Ls[0]))
#pl.loglog(ns,(kbT/(32.)) * A2[ 5,:],'g--')#,label=r'$A^{0,2}(\ell=%2.1f\,nm)$'%(1e9*Ls[5]))
#pl.loglog(ns,(kbT/(32.)) * A2[10,:],'r--')#,label=r'$A^{0,2}(\ell=%2.1f\,nm)$'%(1e9*Ls[10]))
#pl.loglog(ns,(kbT/(32.)) * A2[22,:],'c:'))##, label = r'$A^{0,2}(\ell=%2.1f\,nm)$'%(1e9*Ls[1]))
#pl.loglog(ns,(kbT/(32.)) * A2[24,:],'c--')#,label =r'$A^{0,2}(\ell=%2.1f\,nm)$'%(1e9*Ls[24]))
#pl.loglog(ns,(kbT/(32.)) * A2[22,:],'c:'))##, label = r'$A^{0,2}(\ell=%2.1f\,nm)$'%(1e9*Ls[1]))
#pl.loglog(ns,(kbT/(32.)) * A2[47,:],'y:'))##, label = r'$A^{0,2}(\ell=%2.1f\,nm)$'%(1e9*Ls[2]))
#pl.loglog(ns,(kbT/(32.)) * A2[49,:],'y--')#,label =r'$A^{0}(\ell=%2.1f\,nm)$'%(1e9*Ls[49]))
#pl.loglog(ns,(kbT/(32.)) * A2[51,:],'y:'))##, label = r'$A^{0,2}(\ell=%2.1f\,nm)$'%(1e9*Ls[3]))
#pl.loglog(ns,(kbT/(32.)) * A2[99,:],'m--')#,label =r'$A^{0,2}(\ell=%2.1f\,nm)$'%(1e9*Ls[99]))
...
pl.figure()
pl.loglog(ns,eiz_z_290,'b-', label = r'$\epsilon^{93}_\hat{z}$')
pl.loglog(ns,eiz_x_290,'b:', label = r'$\epsilon^{93}_\hat{x}$')
pl.loglog(ns,eiz_z_051,'g-', label = r'$\epsilon^{24}_\hat{z}$')
pl.loglog(ns,eiz_x_051,'g:', label = r'$\epsilon^{24}_\hat{z}$')
pl.loglog(ns,eiz_w,'c-', label = r'$\epsilon^{H2O}$')
pl.legend(loc = 'best')
pl.savefig('plots/loglog_eiz_24_93_new_w.pdf')
pl.show()

pl.figure()
pl.plot(ns,eiz_z_290,'b-', label = r'$\epsilon^{93}_\hat{z}$')
pl.plot(ns,eiz_x_290,'b:', label = r'$\epsilon^{93}_\hat{x}$')
pl.plot(ns,eiz_z_051,'g-', label = r'$\epsilon^{24}_\hat{z}$')
pl.plot(ns,eiz_x_051,'g:', label = r'$\epsilon^{24}_\hat{z}$')
pl.plot(ns,eiz_w,'c-', label = r'$\epsilon^{H2O}$')
pl.legend(loc = 'best')
