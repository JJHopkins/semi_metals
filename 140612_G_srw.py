...
pl.figure()
pl.loglog(thetas[:-1],1e21*dGdth[3,:], label=r'$\ell =%1.1f nm$'%(1e9*Ls[3]))
pl.loglog(thetas[:-1],1e21*dGdth[4,:], label=r'$\ell =%1.1f nm$'%(1e9*Ls[4]))
pl.loglog(thetas[:-1],1e21*dGdth[5,:], label=r'$\ell =%1.1f nm$'%(1e9*Ls[5]))
pl.legend()
pl.xlabel('[radians]')
...
pl.figure()
pl.semilogy((180./np.pi)*thetas[:-1],1e23*dGdth[3,:], label=r'$\ell =%1.1f nm$'%(1e9*Ls[3]))
pl.semilogy((180./np.pi)*thetas[:-1],1e23*dGdth[4,:], label=r'$\ell =%1.1f nm$'%(1e9*Ls[4]))
pl.semilogy((180./np.pi)*thetas[:-1],1e23*dGdth[5,:], label=r'$\ell =%1.1f nm$'%(1e9*Ls[5]))
pl.legend()
pl.xlabel('[degrees]')
