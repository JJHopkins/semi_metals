...
Ls = np.arange(4.998e-9,5.001e-9,0.001e-9)  #separation between 2 cyclinders
thetas = np.arange(0.783,0.787, 0.001)
...
pl.figure()
pl.plot(thetas,G[2,:] ,'b-',label= '24w24')
pl.plot(thetas,TT[2,:],'b:')
...
pl.plot(thetas,G[2,:] ,'g-',label= '24v24')
pl.plot(thetas,TT[2,:],'g:')
...
pl.plot(thetas,G[2,:] ,'r-',label= '65w65')
pl.plot(thetas,TT[2,:],'r:')
...
pl.plot(thetas,G[2,:] ,'c-',label= '65v65')
pl.plot(thetas,TT[2,:],'c:')
...
pl.plot(thetas,G[2,:] ,'m-',label= '93w93')
pl.plot(thetas,TT[2,:],'m:')
...
pl.plot(thetas,G[2,:] ,'y-',label= '93v93')
pl.plot(thetas,TT[2,:],'y:')
pl.legend(loc = 'best')
pl.show()
